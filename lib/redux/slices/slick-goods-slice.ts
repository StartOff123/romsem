...
import { Product, ReduxProductState } from '@/types/index';

export const fetchSlickGoods = createAsyncThunk(
	'profile/fetchSlickGoods',
	async (requesUrl: string) => {
		try {
