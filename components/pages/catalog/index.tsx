...
import { fetchGoods } from '@/lib/redux/slices/goods-slice';
        ...
        <div className='pb-16 flex flex-col gap-10'>
            <div className='flex justify-end'>
                <div className='flex items-center gap-4'>
                    ...
                    <Select className='w-[210px]' options={sortFilter} onChange={hanfleSort} placeholder='Сортировка' value={sort} />
                </div>
            </div>
            <div className={classNames(
                (goods && loading === 'succeeded') && 'grid grid-cols-4 gap-x-7 gap-y-16',
