...
import { removeCart } from '@/lib/redux/slices/cart-slice';
        ...
        <div className='flex gap-8'>
            ...
            <div className='flex-1 flex justify-between py-4'>
                ...
                <div className='flex flex-col justify-between items-end'>
                    <span className='text-xl text-indigo-500 font-bold'>{numberWithSpaces(Number(item.price))} ₽</span>
                    <button className='flex items-center gap-2 transition-colors text-zinc-400 hover:text-indigo-500' onClick={handleRemoveClick}>
                        <LuTrash2 />
